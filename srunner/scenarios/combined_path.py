...
class CombinedPath(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True, timeout=600):
        ...
        self._destination_coords = carla.Location(x=210.622116, y=540.773376, z=35.568905)
        
        # Use the specific scene coordinates provided
        self._spawn_coords = carla.Location(x=-11.3, y=25.41, z=36.0)
        self._spawn_yaw = 90.0  # Default spawn yaw in degrees - you can change this value
        ...
        self._waypoint_list = [
            [-1, 40, 34.0, 30, 1],    # Direct waypoint
            [21, 150, 34, 70, 0],        # Road waypoint
            [36, 180, 34, 50, 0]         # Road waypoint
        ]
        ...
        super(CombinedPath, self).__init__(
            "CombinedPath",
            ego_vehicles,
            config,
            world,
    ...
    def _initialize_actors(self, config):
        ...
        blueprint = self._world.get_blueprint_library().find('vehicle.dodge.charger_2020')
    ...
    def terminate(self):
        ...
        super(CombinedPath, self).terminate()

def get_available_scenarios():
    return {"CombinedPath": CombinedPath}