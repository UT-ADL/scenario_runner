...
class VehicleFromTheLeft1(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True, timeout=600):
        ...
        self._destination_coords = carla.Location(217, y=398, z=35)
        self._spawn_coords = carla.Location(x=35.163174, y=112.431503, z=33.828636)
        ...
        self._route_color = name_to_carla_color('green')
        self._start_color = name_to_carla_color('green')
        self._destination_color = name_to_carla_color('green')
        self._wp_color = name_to_carla_color('yellow')
        ...
        super(VehicleFromTheLeft1, self).__init__(
            "VehicleFromTheLeft1",
            ego_vehicles,
            config,
            world,
    ...
    def _visualize_scenario(self, route=None):
        ...
        if self._agent_vehicle and self._agent_vehicle.is_alive:
            ...
            print(f"Agent 1 status - Distance: {distance:.2f}m, Speed: {speed:.2f}km/h")

    def _initialize_actors(self, config):
        # Select vehicle blueprint
        blueprint = self._world.get_blueprint_library().find('vehicle.tesla.cybertruck')
    ...
    def _log_scenario_info(self, complete_route):
        ...
        print(f"Scenario: VehicleFromTheLeft1")
        ...
        #print(f"\nAgent 1 Waypoints in XML format:")
    ...
    def terminate(self):
        ...
        super(VehicleFromTheLeft1, self).terminate()

def get_available_scenarios():
    return {"VehicleFromTheLeft_1": VehicleFromTheLeft1}