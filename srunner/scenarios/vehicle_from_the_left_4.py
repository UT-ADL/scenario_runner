...
class VehicleFromTheLeft4(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True, timeout=600):
        ...
        self._destination_coords = carla.Location(x=-220.457840, y=-9.713061, z=33.844597)
        self._spawn_coords = carla.Location(x=-165, y=389, z=37)
        self._initial_speed = 30  # km/h
        self._waypoint_list = [
        ...
        super(VehicleFromTheLeft4, self).__init__(
            "VehicleFromTheLeft4",
            ego_vehicles,
            config,
            world,
    ...
    def _initialize_actors(self, config):
        ...
        blueprint = self._world.get_blueprint_library().find('vehicle.mercedes.coupe')
    ...
    def _log_scenario_info(self, complete_route):
        ...
        print(f"Scenario: VehicleFromTheLeft4")
    ...
    def terminate(self):
        ...
        super(VehicleFromTheLeft4, self).terminate()

def get_available_scenarios():
    return {"VehicleFromTheLeft_4": VehicleFromTheLeft4}